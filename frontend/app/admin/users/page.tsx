    ...
    return (
        <div className="page-stack">
            ...
            <SectionCard title="User Management" description="Filter by email and status.">
                ...
                {usersQuery.error ? <InlineAlert message={usersQuery.error instanceof Error ? usersQuery.error.message : "Failed to load users."} /> : null}
                            ...
                            <tbody>
                                {users.map((user) => (
                                    <tr key={user.id}>
                                        ...
                                        <td className="text-sm leading-[var(--leading-relaxed)] text-muted">{formatDate(user.created_at)}</td>
